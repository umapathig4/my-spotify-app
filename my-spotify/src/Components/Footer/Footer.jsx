...
whitespace-nowrap pointer-events-none"
          ...
          <div className="flex items-center gap-x-3">
            <div className="relative group/square">
              <SquarePlay
                ...
                className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer"
              />
              <div
      ...
      pointer-events-none"
            ...
            <div className="relative group/micvocal">
              <MicVocal className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer" />
              <div
      ...
      pointer-events-none"
            ...
            <div className="relative group/listmusic">
              <ListMusic className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer" />
              <div
                className="absolute translate-x-[-30%] z-30 px-2 py-1 text-[12px] top-[-35px] opacity-0 bg-[#383838] text-white
      ...
      pointer-events-none"
            ...
            <div className="relative group/monitorspeaker">
              <MonitorSpeaker className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer" />
              <div
                className="absolute translate-x-[-30%] z-30 px-2 py-1 text-[12px] top-[-35px] opacity-0 bg-[#383838] text-white
  ...
  "
            ...
            <div className="relative group/squareminus">
              <SquareMinus className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer" />
              <div
                className="absolute translate-x-[-30%] z-30 px-2 py-1 text-[12px] top-[-35px] opacity-0 bg-[#383838] text-white
      ...
      pointer-events-none"
            ...
            <div className="relative group/maximize">
              <Maximize className="h-[17px] text-[#a9a9a9] hover:text-[#f1f1f1] transition-all duration-150 cursor-pointer" />
              <div
